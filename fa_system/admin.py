...
class ReportAdmin(admin.ModelAdmin):
    list_display = ['reportid', 'analyst', 'topic', 'report', 'month']


class PurchaseAdmin(admin.ModelAdmin):
    list_display = ['purchaseid', 'itemid', 'itemname',
                    'branch', 'month', 'price', 'quantity']


class SalesAdmin(admin.ModelAdmin):
    list_display = ['salesid', 'month', 'branch', 'itemid',
                    'itemname', 'itemgroup', 'price', 'quantity']
